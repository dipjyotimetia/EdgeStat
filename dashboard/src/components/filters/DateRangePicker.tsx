      ...
      {open && (
        ...
        >
          ...
          <div className="space-y-3">
            <div>
              <label htmlFor="date-from" className="block text-xs font-mono text-edge-700 mb-1">From</label>
              <input
                id="date-from"
                type="date"
                value={from}
            ...
            <div>
              <label htmlFor="date-to" className="block text-xs font-mono text-edge-700 mb-1">To</label>
              <input
                id="date-to"
                type="date"
                value={to}
