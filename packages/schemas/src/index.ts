...
import { EVENT_TYPES, VITAL_NAMES, DEVICE_TYPES, INTERVALS, type ParseResult } from './types.js';
...
const eventPropsSchema = z
  ...
  .check((ctx) => {
    if (Object.keys(ctx.value).length > 10) {
      ctx.issues.push({
        input: ctx.value,
        message: 'Maximum 10 event properties allowed',
        code: 'custom',
      });
    }
  });
...
export const listSitesResponseSchema = z
  .object({
    sites: z.array(siteSchema),
  })
  .meta({ id: 'ListSitesResponse' });

export const createSiteResponseSchema = z
  .object({
    site: siteSchema,
    snippet: z.string(),
  })
...
export const pageStatsSchema = z
  .object({
    url: z.string(),
    views: z.number().int(),
    visitors: z.number().int(),
...
export const funnelsResponseSchema = z
  .object({
    funnels: z.array(funnelSchema),
  })
  .meta({ id: 'FunnelsResponse' });

export const createFunnelResponseSchema = z
  .object({
    id: z.string(),
    name: z.string(),
    steps: z.array(funnelStepSchema),
...
export const openApiDocument: ReturnType<typeof createDocument> = createDocument({
  ...
  info: {
    ...
    version: '0.1.0',
    description:
      'Privacy-first analytics engine on Cloudflare. Analytics at the edge. Owned by you.',
  },
  ...
  paths: {
    '/v1/events': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: ingestBodySchema } },
        },
        responses: {
          '202': {
            description: 'Queued',
    ...
    '/api/sites': {
      get: {
        ...
        responses: {
          '200': {
            description: 'OK',
            content: { 'application/json': { schema: listSitesResponseSchema } },
          },
          '401': std401,
          '500': std500,
        },
      ...
      post: {
        ...
        responses: {
          '201': {
            description: 'Created',
            content: { 'application/json': { schema: createSiteResponseSchema } },
          },
          '400': std400,
          '401': std401,
          '500': std500,
    ...
    '/api/sites/{siteId}/timeseries': {
      get: {
        ...
        summary: 'Time-bucketed breakdown',
        tags: ['Analytics'],
        ...authParam,
        parameters: [
          siteIdPath,
          fromQuery,
          toQuery,
          { name: 'interval', in: 'query', schema: { type: 'string', enum: [...INTERVALS] } },
        ],
        responses: {
          '200': {
            description: 'OK',
    ...
    '/api/sites/{siteId}/pages': {
      get: {
        ...
        responses: {
          '200': {
            description: 'OK',
            content: { 'application/json': { schema: pagesResponseSchema } },
          },
          '401': std401,
          '500': std500,
        },
    ...
    '/api/sites/{siteId}/realtime': {
      get: {
        ...
        responses: {
          '200': {
            description: 'OK',
            content: { 'application/json': { schema: realtimeResponseSchema } },
          },
          '401': std401,
          '500': std500,
        },
    ...
    '/api/sites/{siteId}/funnels': {
      get: {
        ...
        responses: {
          '200': {
            description: 'OK',
            content: { 'application/json': { schema: funnelsResponseSchema } },
          },
          '401': std401,
          '500': std500,
        },
      ...
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: createFunnelSchema } },
        },
        responses: {
          '201': {
            description: 'Created',
            content: { 'application/json': { schema: createFunnelResponseSchema } },
          },
          '400': std400,
          '401': std401,
          '500': std500,
